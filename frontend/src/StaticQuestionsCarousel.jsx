...
export default function StaticQuestionsCarousel({ onQuestionSelect }) {
    ...
    if (!staticQuestions.length) {
        return <div className="suggested-prompts-empty">Suggested questions will appear here.</div>;
    }

    // Messenger-style quick reply chips, but paged with explicit prev/next
    // arrows instead of free swipe/drag scrolling.
    return (
        <div className="suggested-prompts-shell">
            <button
                type="button"
